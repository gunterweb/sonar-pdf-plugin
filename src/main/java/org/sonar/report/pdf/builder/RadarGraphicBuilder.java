...
public class RadarGraphicBuilder extends AbstractBuilder {
	...
	public Image getGraphic(final RadarGraphic radarGraphic) {
		...
		try {
			String requestUrl = sonarBaseUrl + "/chart?ck=xradar&w=210&h=110&c=777777|F8A036&m=100&g=0.25&" + "l=Eff.("
					+ radarGraphic.getEfficiency() + "%25),Mai.(" + radarGraphic.getMaintainability() + "%25),Por.("
					+ radarGraphic.getPortability() + "%25),Rel.(" + radarGraphic.getReliavility() + "%25),Usa.("
					+ radarGraphic.getUsability() + "%25)&" + "v=" + radarGraphic.getEfficiency() + ","
